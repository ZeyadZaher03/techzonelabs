...
// device detection
const HamMenuAboutMenu = document.querySelector(".hamburger-menu_about-menu");
const HamMenuAboutMenuBtn = document.querySelector("#hamburger-menu_about");
let HamMenuAboutMenuSwitch = false;
HamMenuAboutMenuBtn.addEventListener("click", () => {
  if (!HamMenuAboutMenuSwitch) {
    HamMenuAboutMenu.classList.add("hamburger-menu_about-menu_open");
    HamMenuAboutMenuSwitch = true;
  } else {
    HamMenuAboutMenuSwitch = false;
    HamMenuAboutMenu.classList.remove("hamburger-menu_about-menu_open");
  }
});
...
menuBtn.addEventListener("click", (e) => {
  if (isMenuVis) {
    ...
    document
      ...
      .classList.remove("hamburger-menu_open");
    return (isMenuVis = false);
  } else {
    menuBtn.classList.add("menu-bar-open");
    document
      .querySelector(".hamburger-menu")
      .classList.add("hamburger-menu_open");
